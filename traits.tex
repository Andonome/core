...
\begin{description}
  \item[\roll{Strength}{Medicine}]
    ...
    If someone has only 1 \gls{hp} of Damage, the medicus can heal it, leaving them with only 1 \gls{ep} instead.
...
\makeAutoRule{npcFatigue}{\Glsfmtplural{npc} \Glsfmtplural{ep}}{assume \glsfmtplural{npc} start with half \glsfmtplural{ep} filled}
