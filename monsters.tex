...
\iftoggle{bestiarychapter}{%
$3D6-2$gp}{%
\multiply\value{r3} by \value{r4}\arabic{r3}gp}%
}
...
\iftoggle{bestiarychapter}{}%
	...
	{\ifodd\value{r3}%
		\ifodd\value{r4}%
			Portal Scroll\else
			Deck of Cards\fi\else
		Bag of Tricks\fi}}}

\newcommand{\lootJewellery}{%
\iftoggle{bestiarychapter}{jewellery worth $3D6$sp}%
	{\ifnumcomp{\value{r2}}{>}{1}{\ifodd\value{r3}%
		\ifodd\value{r4}%
			golden necklace worth \thepage sp\else%
	...
	{\ifodd\value{r3}%
		...
		saphire pendant worth \thepage cp\fi}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                           _
...
\newcommand{\elvenenchanter}[1][\npc{\M}{Elven Enchanter}]{
	...
	{\Dagger, \lootJewellery\ifodd\thepage, \randomtwo\lootJewellery\fi}% EQUIPMENT
	{\mana{6}}
}
...
{0}% DR
{2}% AGGRESSION
{Academics \arabic{r2}, Deceit \ifodd\thepage 2 \else 1\fi, Performance \ifodd\thechapter 2 \else 1\fi\ifnum\value{r12}>9{\Path{Song}{Illusion \arabic{r2}, Fate \arabic{r3b}}}\fi}% SKILLS
{\ifnum\value{enc}>5%
	{\shortsword, dagger, }%
...
{\lootMedium, \lootMagic}% EQUIPMENT
...
\else%
	\greatsword, dagger%
\fi%
\ifodd\thepage, \lootBig\fi}% EQUIPMENT
{}
}
...
{\Dagger, mana stone holding 6 MP, \ifodd\thechapter\lootJewellery\fi}% EQUIPMENT
...
{\Dagger, mana stone holding 6 MP, \ifodd\thepage\lootMagic, \fi\ifodd\thechapter\lootJewellery\else\lootBig\fi}% EQUIPMENT
{\mana{6}\setcounter{spd}{\value{wts}}}
}
...
{\ifodd\value{r3}\longsword\else\Dagger\fi, \lootMagic, \lootJewellery, \randomtwo\lootJewellery}% EQUIPMENT
