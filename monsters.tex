...
{2}% DR
{2}% COMBAT
{Aggression 2, \ifodd\thepage Beast Ken \else Deceit \fi \arabic{r3}, Survival \arabic{r3b}, Tactics \arabic{r2}, Vigilance 1}% SKILLS
{\ifodd\value{r2}%
	\longsword%
	\ifodd\value{r4}%
		\partialleather%
...
\ifodd\value{r4}%
	\partialplate%
\fi%
mana stone holding 6 MP, \ifodd\thepage\lootMagic, \fi\ifodd\thechapter\lootJewellery\else\lootBig\fi}% EQUIPMENT
{\mana{6}}
}
...
\else%
	\Dagger%
\fi, \lootMagic, \lootJewellery, \randomtwo\lootJewellery}% EQUIPMENT
{\mana{6}\lockedmana{3}}
}
