...
{0}% DR
{\arabic{r2}}% COMBAT
{Academics \ifodd\thepage\arabic{r2}\else\arabic{r3b}\fi, Deceit \ifodd\thepage 2 \else 1\fi, Performance \ifodd\thechapter 2 \else 1\fi%
\ifnumcomp{\value{r12}}{>}{9}{%
\Path{Song}{Fate \arabic{r3}, Illusion \arabic{r3b}} }{}
}% SKILLS
...
{\ifodd\value{r3}\longsword\ifodd\value{r4}\completechain\else\partialplate\fi\else\Dagger\fi, \lootMagic, \lootJewellery, \randomtwo\lootJewellery}% EQUIPMENT
...
{\ifnum\value{gold}>0 Stealth \arabic{gold}\else Projectiles \arabic{r4}\fi, \knacks{\ifodd\thepage\disarm, \fi \unstoppable}}% SKILLS
