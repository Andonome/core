...
\randomdozen\addtocounter{r12}{5}\arabic{r12}gp}%
}
...
{\ifodd\value{gold}%
	...
	\ifnum\value{r4}=1%
		\partialleather, %
	\fi%
\ifodd\thepage\lootMedium\else\lootSmall\ifodd\thechapter, \lootJewellery\fi\fi}% EQUIPMENT
{}
}
...
{\ifnum\value{enc}>5%
	...
	\else\ifnum\value{age}>2%
		{\rapier, dagger, }%
		\else\fi\fi%
	\lootMedium\ifodd\thepage, \lootJewellery\fi}% EQUIPMENT
...
\ifnum\value{r3}>1%
	...
	\fi%
\Path{Divinity (Qualm\"e)}{\ifodd\value{r2} Fate\else Aldaron \fi \arabic{r3},  Necromancy \arabic{r3b}}}% SKILLS
{\Dagger}% EQUIPMENT
{\mana{4}}
}
