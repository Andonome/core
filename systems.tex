...
\makeAutoRule{rafting}{Boating}{go 15 miles downstream or 5 miles up with \pgls{ep}}
Boating downriver lets people travel at three times the normal speed (15 miles per \gls{interval}).
Boating \emph{up} a river is at normal speed (5 miles per \gls{interval}) but comes with \pgls{ep}.
\index{Rafting|see {Boating}}
Gliding along placid waters, like a loch, mean travelling at 10 miles per \gls{interval}.

All travel on the water allows people to ignore any \gls{weight}.
