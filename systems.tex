...
\makeRule{place_fire}{Placing fires}{Intelligence}{Caving}{11 to avoid filling the cavern with smoke, and receiving 2~\glsfmtplural{fatigue} per \glsentrytext{interval}}
...
\makeRule{navigate_land}{Navigating on land}{Intelligence}{Wyldcrafting}{by terrain type}
\index{Navigation}
\index{Marching}
