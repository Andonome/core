...
\makeRule{hypoxia}{Hypoxia}{Intelligence}{Caving}{10 to notice problem, gain \glsfmtplural{ep} on failure}
...
\makeRule{keep_watch}{Keeping watch over night}{Strength}{Vigilance}{7.  3 \glsfmtplural{ep} between watchers}
...
\makeAutoRule{march}{Marching}{gain 1~\glsfmtplural{ep} each mile of rough terrain, and 1~\glsfmtplural{ep} for every 2~miles of road, each \glsfmttext{interval}}
\index{Walking}
\index{Marching}
\index{Travel}
Marching characters gain 1~\glspl{ep} each mile of rough terrain, and 1~\glsfmtplural{ep} for every 2~miles of road, each \gls{interval}.
...
\makeAutoRule{cold}{Cold Seasons}{gain 2~\glsfmtplural{ep} each \glsfmttext{interval} and need fire to rest}
\index{Winter}
\index{Cold Seasons}
\index{Snow}
...
\makeRule{place_fire}{Placing Fire Undergound}{Intelligence}{Caving}{11 to avoid filling the cavern with smoke, and receiving 2~\glsfmtplural{ep} per \glsentrytext{interval}}
