...
A particularly good workshop or kitchen gives a +1 or +2~Bonus, and a large enough library can grant a +1~Bonus.
...
\makeRule{identifyDisease}{Curing a Disease}{Intelligence}{Medicine}{12}
\index{Disease!Identifying|glsentrysymbol{eldren}}%
...
The doctor can gain a Bonus for tools, such as herbs, or rare stones (up to +1), or from access to medical treatise (+1 to a weighty tome, +2~for a full library).
