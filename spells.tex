...
\spell{Infectious Migraine}% Name
  ...
  {Fate, Air}% Spheres
  {\roll{Strength}{Athletics}}% Resist with
  {As the caster roars, a deathly feeling flows over the targets, who gain \arabic{spellCost} \glspl{ep}}% Description
  {}
...
\spell{Night Terrors}% Name
  ...
  {Fate, Fire}% Spheres
  {\roll{Charisma}{Wyldcrafting}}% Resist with
  {A wail in the darkness, then a fire at \spellRange\ goes out.
  And whoever held it loses \showDam~\glspl{fp}}% Description
  {}
