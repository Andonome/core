...
An entire \gls{region} can feel the pull, but more distant \glspl{area} will only have their ambient \glspl{mp} reduced by one or two.
...
\iftoggle{verbose}{}{
  ...
  \spell{Asking Rock}% Name
    ...
    Once the rock has a weapon, the \gls{gm} makes an encounter roll}% Description
    {
      ...
      \exRef{verbose}{Judgement}{civilizationRating}
...
\spell{Vomit Mana}% Name
  ...
  {`\textit{Breathe ash and piss rocks}' -- the caster shouts malformed bodily actions, and \arabic{spellTargets} release \arabic{spellPlusOne}~\glspl{mp} into the air}% Description
