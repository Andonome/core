...
\item{Spend 50 XP on Attributes and Skills. You might also buy Knacks or Magic. (Page \pageref{xp})}
\item{Grab some adventuring items and weapons. (Page \pageref{start_equipment})}
\item{Select a god or code to follow, which grants you XP. (Page \pageref{gods_codes})}
