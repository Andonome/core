...
\noindent
You can leave your Attributes at `0', or roll `2D6' to set any to a random number.
\iftoggle{verbose}{%
...
\begin{itemize}
  ...
  Write down Combat +1, Projectiles +1, Crafts +1, Larceny +2, Stealth +1, and the knack Specialist (locks).
...
\begin{itemize}
  ...
  We're tired of being ignored, but there's on place you'll listen\ldots
