...
\begin{exampletext}
  ...
  His songs had made the nobles to hosted the troupe cry, but here in the market the crowd remained three beggars and a dog.
  ...
  And half the market -- already her crowd -- sang the last line in response.
...
\begin{exampletext}
  ...
  It had cost him two whole \glsentrylong{gp} to gather the wool, paper, and wax, and have the Paper Guild fashion the white squares.
...
\begin{exampletext}
  ...
  Would you pour me another?'', the tiny little lady handed over another \glsentrylong{gp}.

  ``No change again!
  What happened to all the copper and silver I gave you last time?
  I can't keep changing large coins like this\ldots''

  He handed over 9 \glsentrylongpl{sp} with the head of \iftoggle{aif}{Dalyus Rex}{an ancient king}, without any wear or tarnish.
