...
\newglossaryentry{cleverbaron}{
	...
	description={is a villagemaster, currently plotting to overthrow \glsentrytext{king} by collecting magical items from the nura}
	}
