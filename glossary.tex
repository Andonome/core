...
\iftoggle{aif}{
  ...
  \newglossaryentry{adventure}{
    name={Adventuring},
    text={adventuring},
    first={\textit{Adventuring}},
    nonumberlist,
    description={This refers either to the players' current goals, or a single session}
  }
}
...
\newglossaryentry{area}{
  ...
  \newacronym[description={The smallest unit of currency},
  shortplural={cp},
  text={copper piece},
  longplural={copper pieces},
  ]{cp}{cp}{Copper Piece}

  \newacronym[description={One silver piece is worth one hundred copper pieces},
  text={silver piece},
  shortplural={sp},
  longplural={silver pieces},
  ]{sp}{sp}{Silver Piece}

  \newacronym[description={One gold piece is worth ten silver pieces, or one thousand copper pieces},
  shortplural={gp},
