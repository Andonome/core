...
\newcommand{\dwarventrader}[1][\npc{\M}{Dwarven Trader}]{
	...
	{\shortsword, \ifnumcomp{\thechapter}{=}{\value{bestiarychapter}}{$3D6$sp}{\setcounter{gold}{\thepage}\arabic{gold}sp}}% EQUIPMENT
	{}
	}
%
...
{\ifodd\value{r2}\woodaxe\else\javelin, dagger\fi}% EQUIPMENT
{}
}
...
{\arabic{r2}}% AGGRESSION
{Aggression 2, Projectiles \arabic{r2}, Academics \arabic{r3}, Deceit 1, Medicine \arabic{r2b}, Vigilance \arabic{r2}
\Path{Devotion (Qualm\"e)}{Fate \arabic{enc}, \ifodd\value{r4} Invocation \arabic{r3}\else Aldaron \arabic{enc}\fi, Necromancy 5}}% SKILLS
{\Dagger, mana stone holding 6 MP, \arabic{page}sp worth of jewellery}% EQUIPMENT
{\mana{6}\setcounter{spd}{\value{wts}}}
}
