...
\Pgls{round} itself can then be further divided into \glspl{ap} if you want real detail, but that's covered later.
...
The troupe can declare \pgls{downtime} at any point.
