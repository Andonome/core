...
Each point over this limit removes \pgls{ap} at the start of each \gls{round}.

The average gnome has 4~\glspl{hp}, so they can carry a poleaxe (\gls{weight}~3) but suffer a -2~Penalty.
