...
\begin{itemize}
  ...
  \item
  Roll below below, the danger becomes reality.
  \item
...
If the dice roll a tie, the \gls{gm} might allow a re-roll where it makes sense to sink further time into a project to acheive a different result.
