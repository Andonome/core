...
All creatures have \pgls{weight} equal to triple their maximum \glspl{hp}.
If a human with 7~\glspl{hp} picks up another with 7~\glspl{hp}, they receive a -3~Penalty; the same goes for gnomes and gnolls, or any two people with roughly equal body-sizes, because the \gls{weight} equals their own \glspl{hp} times three.
