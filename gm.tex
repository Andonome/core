...
Obviously, this system is not going to represent anything with much accuracy, but it's better than stopping to compute a minor battle when the \glspl{pc} aren't involved.
