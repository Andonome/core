...
Everyone begins combat with 3~\glsentryfullpl{ap} plus their Speed Bonus, then spends their \glspl{ap} to attack.%
...
each inflict a penalty, so characters can find themselves pushed into taking heavy penalties once overwhelmed.
...
\makeAutoRule{falling}{Falling Damage}{equals half the \glsfmtplural{step} fallen, plus the characters Strength.}
\index{Falling}
