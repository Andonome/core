...
\newcommand{\weaponschart}{
	...
	Boulder & +3 & -1 & \ 0 & 4/6 & Finishing Blow (page \pageref{finishingblow}) \\
...
\paragraph{Wearing armour} All armour adds a number of Fatigue points equal to the armour's \gls{weightrating}.
As usual, the \gls{weightrating} is 1 higher for Complete Armour.
