...
\Gls{dr} applies before \glspl{fp}, so if a character with leather armour (\gls{dr}~3) and 5~\glspl{fp} took 10~Damage, they would reduce the Damage by 3, then remove all 5~\glspl{fp}, and finally apply 2~Damage.
