...
Any \gls{dr} (whether from thick hide or armour) adds half its value to the Strength Bonus, while any other type of item with a positive \gls{weight} subtracts itself from the ability to fly properly.

Anyone with the Air Sphere can use this as a Bonus to aid their flight, but will have to spend 1 \gls{mp} to begin the spell.
