...
\emph{However}, when the enemy has enough \glspl{ap} to attack, they can interrupt any movement to attack (after which the movement may continue, if the character can still move).%
...
Characters with a shield can add the shield's Bonus.
They're more `blocking' than `dodging', but it works the same way.
