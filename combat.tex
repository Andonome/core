...
\newcommand{\initiativechart}{
	...
	\hspace{4em}\textbf{Striking} & \\\hline
	...
	\hspace{4em}\textbf{Projectiles} & \\\hline
	...
	\hspace{4em}\textbf{\Glspl{quickaction}} & \\\hline
...
Animals use a Skill called Aggression.
It works exactly like the Combat Skill but only adds to the Strike Factor, and never to Initiative or Evasion.
...
\newcommand{\weaponschart}{
	...
	Cast Iron Skillet & +2 & \ 0 & \ +1 & -1/1 & & Adrenaline Surge (page \pageref{adrenalinesurge}) \\
...
\subsubsection[Blindness: -8 penalty + Wit + Vigilance (maximum -6). Rolling equal to allies means hitting an ally]{Blindness}
...
\subsubsection[Darkness: Penalty equals difference between combatants' Wits + Vigilance]{Darkness}\label{darkness}\index{Darkness}
...
\subsubsection[Spell Casting: Combat Skill cannot be added to Evasion, and lowest of Wits or Speed is used for Initiative. -2 penalty to cast]{Spell Casting in Combat}\index{Combat!Spell Casting}
\label{combatcasting}
