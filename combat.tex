...
\newcommand{\initiativechart}{
	...
	\begin{tcolorbox}[title={Initiative Costs},tabularx={XX},bottom=10pt]
...
\newcommand{\armourchart}{
	...
	\begin{tcolorbox}[tabularx={ccccX},bottom=10pt,top=10pt]
...
\newcommand{\moralechart}{
	\begin{tcolorbox}[title={Morale Chart},tabularx={cX},bottom=10pt,top=10pt]
