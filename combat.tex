...
When the party take any part of the day to rest, they can heal a number of \glspl{fatigue} equal to half their \textit{current} \glspl{hp}; so someone with 4 out of 8 \glspl{hp} would be able to recoup 2 \glspl{hp} by resting, either for a full night, or by taking some chunk of the afternoon to sit quietly.%
