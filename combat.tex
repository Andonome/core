...
any number of things might happen, so the \gls{gm} should select something appropriate, or roll for a random result.
...
\begin{dlist}
  ...
  \item You trip and all over, going \textit{prone}.
  \item You move into something hard, spikey, or otherwise dangerous.
  Take \dmg{0}~Damage.
  \item Hit an ally.
