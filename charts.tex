...
\newcommand\XPchart{
  \begin{nametable}[XYYYYYY,float*=b]{\Glsentrytext{xp} Chart}
    \textbf{Level} &  \textbf{Attributes}  &  \textbf{Skill}  & \textbf{Combat/ \mbox{Projectiles}}  & \textbf{\Glsentrytext{fp} Base} &  \textbf{Knacks} & \textbf{Sphere}  \\
    \hline
    <1                &   5        &         &                      &         0 (5 \glsentrytext{fp})  &      & \\
    1st               &   10       &   5     &        10            &        10 (10 \glsentrytext{fp}) &   5  &    10  \\
    2nd               &   20       &   10    &        20            &        15 (15 \glsentrytext{fp}) &  10  &    15  \\
    3rd               &   30       &   15    &        40            &        25 (15 \glsentrytext{fp}) &  15  &    25  \\
    4th               &   50       &         &                      &        45 (15 \glsentrytext{fp}) &  20  &    45  \\
    5th               &            &         &                      &        85 (15 \glsentrytext{fp}) &  25  &    85  \\
...
\newcommand{\weaponschart}{
  ...
  \textbf{Name} & \textbf{Attack Bonus} & \textbf{Damage Bonus} & \textbf{\Glsfmtshort{ap} Cost} & \textbf{\Glsentrytext{weightrating}} & \textbf{Cost} \\\hline
...
\newcommand\tempoChart{
  \begin{rollchart}
    ...
    8 & Two encounters strike the troupe at the same time, and add another for the next two days. If more than one encounter happens on the same day, they always double up! \\
    7 & Two encounters strike the troupe at the same time! \\
