...
%----
		...
		\setcounter{track}{18}
		\posterbox{name=track,column=27,row=1,span=3,rowspan=12}{ 
			{\large
...
%----
		...
		\posterbox[adjusted title=Damage]{name=track,column=1,row=4,span=5,rowspan=1}{ 
	\tiny{(Strength)}
}
...
%----
	...
	\posterbox[adjusted title=Skills (5/10/15)]{name=skills,column=19,row=9,span=8,rowspan=4}{
		\begin{tabular}{lp{0em}p{0em}p{0em}}
...
%----
	...
	\posterbox[adjusted title=Equipment (1 per Skill)]{name=equipment,column=1,row=10,span=18,rowspan=3}{
