...
%----
	...
	\posterbox[blankest]{name=factors,column=2,row=4}{\begin{tikzpicture}
...
%----
	...
	\posterbox[adjusted title=Racial Abilities]{name=racial_abilities,column=5,row=7,rowspan=1,span=6}{}
