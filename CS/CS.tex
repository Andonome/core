...
%----
  \posterbox[
    ...
    \begin{tabularx}{\linewidth}{lXlXlX}
      \hiderowcolors
      Name: & \hrulefill & Player: & \hrulefill & Code: & \hrulefill \\
      \\

      Concept: & \hrulefill & Race: & \hrulefill & Culture: & \hrulefill \\
    \end{tabularx}
}
...
%----
  ...
  remember,
    ...
    \begin{tabularx}{\linewidth}{p{.3\textwidth}XXXX}
      ...
      Weapon & Bonus & Damage & AP Cost & Weight \\
...
%-----
  ...
  {name=Derived,column=1,row=5,span=10,rowspan=4}{
    \begin{tabularx}{\linewidth}{YYY}
      ...
      Attack & Damage & AP \\
      \\
      \footnotesize 2D6+ \underline{\hspace{2em}} & \footnotesize \underline{\hspace{1em}} D6+\underline{\hspace{2em}} & \footnotesize \underline{\hspace{2em}} \\
