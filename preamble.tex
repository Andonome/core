...
\titleformat{\subsection}{\needspace{5em}\center\large\bfseries}{}{1em}{}[\rule{.9\linewidth}{.2pt}]
%
...
\newcommand{\sidequest}[1]{\subsubsection[#1]{#1 -- \encnum}}
\newcommand{\forest}[1]{\subsubsection{(\ding{168} Forest) #1}}
\newcommand{\town}[1]{\subsubsection{(\ding{169} Town) #1}}
