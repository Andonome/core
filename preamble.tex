...
\tcolorboxenvironment{boxtext}{breakable}
\tcolorboxenvironment{speechtext}{breakable}
...
\newcommand{\sqpart}[3]{\resumecontents[#1]\subsubsection[\iftoggle{firstsq}{\CheckedBox}{\ding{111}} #2 -- #3]{(#1) #2}\stopcontents[#1]\settoggle{firstsq}{false}}
