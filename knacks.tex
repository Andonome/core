...
The Knack cannot be bought multiple times, but two characters with the Knack can add their Bonus.%
\footnote{Or rather, the first adds +1, and the second adds +$\frac{1}{2}$, and so on, like any \gls{bandAct}.}
