...
The caster rolls Intelligence + Combat to levitate the weapon at a \gls{tn} equal to 7 plus the weapon's \glsentryshort{weightrating}.
The weapon has effective Strength, Dexterity, and Speed Bonuses of `-1' plus the caster's Intelligence Bonus.
The caster's Combat Bonus and weapon's Attack Bonus adds to any attack rolls it makes%
\iftoggle{verbose}{, so caster's with Intelligence +2 and Combat +2, casting a \textit{Potent Dancing Swords} could animate a longsword to fight with Strength +2, Dexterity +2, and Speed +2, giving it a total of +5 to attack, and dealing $2D6$ Damage.
...
\spell{Mage Armour}{Continuous}{Academics}{Create a magical barrier with $\gls{lv} + Int$ \glsentryshortpl{SP}}
