...
If the spell is successful, it inflicts no Damage nor \glspl{fatigue}, but the target counts as carrying an item with a \glsentryname{weightrating} equal to the level of the Force sphere being used.
