...
The blast spans out, affecting a number of squares equal to the spell's level plus the mage's Wits Bonus.
...
The mage focusses on a dreaming target and perceives their dreams.
...
Anyone within a dream can cast any spells.
Any damage inflicted reduces to $1/5$th of that Damage, before being converted into Fatigue Points.
Any enchantment spells work as normal.

Illusion spells are bolstered, and always have Strength, Dexterity, and Speed Attributes equal to the spell's level.
Everyone in dreams has +1 levels in the Illusion sphere, so everyone has at least 1 level in the illusion sphere, although they may not have the mana to cast anything.

If the caster fails at the roll, they have been spotted by the dreamer, and the dreamer will easily understand that another sentience creature has violated their space.
