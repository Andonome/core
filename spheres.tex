...
\spell{Transmutation}{Continuous}{Varies}\\
...
\spell{Levitation}{Continuous}{Craft}\\
...
\spell{Darkness}{Instant}{Survival}\\
...
\spell{Ghoul Calling}{Instant}{Medicine}\\
...
\enhancement{1}{Enervated}
\index{Spell Enhancements!Enervated}
The mage adds a level to the spell to increase the maximum number of \glspl{hp} by 2.
A mage with Intelligence +2 could raise a solder with 8 \glspl{hp} with an \textit{Enervated Ghoul}.
With the fourth level, the mage could raise a basilisk with 12 \glspl{hp}.

\enhancement{1}{Cunning}
