...
\iftoggle{verbose}{
\vfill\null
	\includegraphics[width=.9\linewidth]{images/Roch_Hercka/vitals_shot.jpg}
	\label{roch:vitals}
}{}
...
\enhancement{1}{Metalic} The caster can now target and create basic metals such as copper, bronze, or iron.  Gold and silver cannot be targeted or created, nor can alloys, or weapons adorned with precious metals.
...
\enhancement{1}{Transient} The conjuration spells can now move from any type of matter to any other.  Webbing, slime, or acid can be created from any substance except metals.
...
\enhancement{1}{Gated} The mage can not simply teleport something but open a doorway from one place to another, within the normal range.
