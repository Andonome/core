...
\iftoggle{verbose}{%
	...
	They could never figure it out, so you eventually convinced them to teach you how they communicate through whistles.
	\end{itemize}
}{}
...
\iftoggle{verbose}{
	...
	\item Despite your bad manners, you have learnt to read while a member of the thieves' guild some time ago.
	You used to use this just for forgeries, but there's nothing in principle stopping you from reading a book.
	\item Protecting your siblings from chitincrawler attacks on multiple occasions gave you all the knowledge you need to defend them.
...
\iftoggle{verbose}{%
	\begin{itemize}
	\item When the game starts, you pick another character as cousin.
