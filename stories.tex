...
Each time a player spends a \glspl{storypoint}, the character earns 2 \glspl{xp}.
\iftoggle{verbose}{%
	This isn't much, but the slow tricks promotes character growth as the backstory creates character growth.
}{}
