...
This \gls{npc} refuses to join the party on any martial escapades.
...
The character has the same stats as above in `I know a guy who'd be perfect', but this time would happily aid the party on a martial adventure.
They join only to complete a single well-defined task, and will leave if the party even stop pursuing that task, or after 5 scenes (whichever comes first).
...
Additionally, their minimum Intelligence Bonus is +2, and they have one magic sphere at 4th level, and another two at 2nd level.
