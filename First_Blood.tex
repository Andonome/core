...
The mage casts a dim light, about the strength of a torch, which surrounds any target.
...
%\enhancement{1}{Form Breaking} The mage can turn any state -- solid, liquid or gas -- into any other state.  Air can turn into a liquid, and water can turn into stone.

%\enhancement{1}{Massive Transformation} Spells that would normally target only a limited space can now target a number of squares equal to the spell's level plus the caster's Wits Bonus.  If a caster had Wits +1 and turned water into slime with a second level spell, the spell would affect 3 squares in total.

%\enhancement{1}{Metal} Spells can now target and create non-precious metals, such as copper, bronze and iron.

%\enhancement{2}{Valueable Metal} As above, but the caster can now target and affect any metal.
...
\enhancement{1}{Fireball} The caster turns the flamebolt into a raging fireball, which covers a number of squares equal to the spell's level plus the caster's Wits.
...
If the spell does not have the Inner Furnce enhanvement, it always targets people's outer layers; their swords, armour, clothing, but not the person themselves, unless that person was mostly naked.
