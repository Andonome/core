...
We measure weight in broad terms.  Characters have a weight rating equal to their Hitpoints, so elves tend to have 5, while humans tend to have a Weight of 7.  Items work similarly, with weight ratings between -3 (for very light items) and +11 (for wardrobes, carts, and boulders).
