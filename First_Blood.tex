...
The roll for this spell is Intelligence + Medicine Skill. The basic TN is 7 and every HP increase or decrease the mage wants to affect will increase the TN by 1. For example, transforming from a human (with a +1 bonus to Strength) to a gnome (with a -2 penalty to Strength) would mean a TN of 10.
