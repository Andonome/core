...
Casters roll their Intelligence + Survival at a TN of 7 + the target's Strength + Athletics. Alternatively, players can avoid being stuck in the web by rolling Strength + Athletics, at TN 7 + the caster's Intelligence + Survival.

Anyone can attempt to break free instea of their usual movement action.
...
The caster can open a magical portal from one place to another.  The only restriction is that the two areas can be at maximum \arabic{spelllevel} + the caster's Wits apart.
