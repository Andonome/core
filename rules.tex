...
\begin{boxtable}[XcX]
  ...
  Dog & & 2 \glsentrytext{sp} \\

  Donkey &   &  2 \glsentrytext{sp} \\

  Horse &   &  5 \glsentrytext{gp} \\

  War Horse &   &  8 \glsentrytext{gp} \\

  Leather Barding &   &  1 \glsentrytext{gp} \\

  Chain Barding &   &  2 \glsentrytext{gp} \\

  Plate Barding &   &  15 \glsentrytext{gp} \\
...
\begin{boxtable}[XcX]
  ...
  Cottage & &  20 \glsentrytext{gp} \\

  Keep & &  1,000 \glsentrytext{gp} \\

  Small Castle & &  4,000 \glsentrytext{gp} \\

  Medium Castle & &  10,000 \glsentrytext{gp} \\

  Large Castle & &  30,000 \glsentrytext{gp} \\
...
\begin{boxtable}[XcX]
  ...
  Peasant clothes &  -3 &  50  \glsentrytext{cp} \\
...
\begin{boxtable}[XcX]
  ...
  Grappling hook &  -2 &  1 \glsentrytext{sp} \\

  Ink bottle &  &  2 \glsentrytext{sp} \\

  Iron rations &  -2 &  10 cp \\
  

  Lantern &  -2 &  3 \glsentrytext{sp} \\

  Lock pick set &   &  10 \glsentrytext{sp} \\

  Metallurgy set &  6 &  40 \glsentrytext{sp} \\

  Parchment sheet &   &  1 cp \\

  Quill &   &  4 cp \\

  Rope, 50' &  -1 &  2 \glsentrytext{sp} \\

  Rope, silk, 50' &  -4 &  3 \glsentrytext{sp} \\
...
\begin{tcolorbox}[tabularx={XX},title=Services,bottom=10pt,left=3pt,right=3pt,code={\rowcolors{2}{}{gray!10}}]
  ...
  \textbf{Apothacary} & 1 \glsentrytext{sp} / level of Intelligence + Medicine \\\hline

  Poison cure & 1 \glsentrytext{sp} \\

  Poison & 4 \glsentrytext{sp} \\\hline
  ...
  \iftoggle{aif}{
    ...
    Dangerous area & 1 \glsentrytext{sp} \\

    Uncharted area & 50 \glsentrytext{cp} \\
  }
  \hline
  \textbf{Hospitality} &  \\\hline

  Public House & 0 \glsentrytext{cp} \\

  Meal & 5 \glsentrytext{cp} \\

  Barn with breakfast & 10 \glsentrytext{cp} \\

  City Inn & 40 \glsentrytext{cp} \\

  Fancy Room & 1 \glsentrytext{sp} \\\hline

  \textbf{Minstrel} &  15 cp/ performance \\\hline

  Large audience & 500 \glsentrytext{cp} \\

  Massive audience & 1 \glsentrytext{sp} \\
  ...
  Opponent & \gls{xp}$^3$ \glsentrytext{sp} \\

  Illegal Murder & 10 \glsentrytext{sp} \\\hline
  ...
  \iftoggle{aif}{
    ...
    Dangerous area & 2 \glsentrytext{sp} \\

    Uncharted area & 4 \glsentrytext{sp} \\
  }\hline
