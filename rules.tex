...
The player can decide to replace any of these items with a generic item called \gls{adventure} equipment.
If a player has an \gls{adventure} equipment item, they can decided to describe exactly what it is later in the game.
