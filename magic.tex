...
The mage must cast the spell immediately after \textit{Pocket Spell}, which must be cast on a freshly-made Mana Stone.

Some mages create scrolls which become useless once read.  Some priests of \gls{naturegod} enchant animals with a single spell, just to see how the animal will use it.
...
This enhancement increases an item's Potency by 1.
\iftoggle{verbose}{%
	A \gls{miracleworker} with Intelligence +1 would normally create items which last for 1 scene, with an effective Intelligence and Wits Bonus of +1.
	However, by casting with this enhancement, the item gains a Potency of +2, so all rolls gain a +2 Bonus, it lasts for 2 scenes, and if the spell is cast as a \textit{Wide} spell, it covers a number of squares equal to its level +2.
}{}
...
This enhancement affects magical items such as Pocket Spells, Talismans, and Artefacts.
