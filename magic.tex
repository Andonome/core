...
\spell{Identify Item}{Instant}{Academics}\\
...
\spell{Pocket Spell}{Instant}{Crafts}\\
...
\spell{Artefact}{Continuous}{Academics}\\
...
Magical items which do not have enough mana simply fail to cast. The one exception here is the Path of Song, wherein spell-songs which have too much mana drawn from them simply break, rendering the Artefact-song useless.
...
\spell{Greater Artefact}{Instant}{Academics}\\
...
\spell{Greater Mana Stone}{Continuous}{Academics}\\
