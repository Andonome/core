...
\spell{Artefact}{Continuous}{Academics}{Sacrifice one permanent \gls{mp} in a mana stone to let it cast a spell}\\
...
\spell{Greater Artefact}{Instant}{Academics}{As `Artefact', but the item gains a full sphere of magic}\\
