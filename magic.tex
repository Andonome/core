...
The mage would be left with only 2 \glspl{mp}, but the stone would have 6 \glspl{mp}.
...
\iftoggle{verbose}{
	For this reason, adventuring parties cannot make use of as many magical items as they might have.
}{}
