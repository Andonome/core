...
\begin{description}
  ...
  I'll take both.
  \item[\gls{gm}:]
  Roll \roll{Wits}{Crafts} to determine the quality of the goods (\glsentrylong{tn}~9).
  \item[Player 1:]
  \dicef{7}
  Is an `8' good?
  \item[\gls{gm}:]
...
\begin{description}
  ...
  Can you roll \roll{Wits}{Vigilance} at \glsentrylong{tn}~12?
  \item[Player 2:]
  Crap\ldots
\end{description}
...
\begin{description}
  ...
  You can roll \roll{Speed}{Athletics} at \glsentrylong{tn}~11.
  \item[Player 3:]
  Okay, \dicef{7} \ldots sorry, Grogfen.
\end{description}
...
\begin{description}
  ...
  \item[\gls{gm}:]
  Yes -- it's still \glsentrylong{tn}~11, but you can roll your \roll{Charisma}{Earth} to cast.
  \item[Player 1:]
  \dicef{9} Got it!
  \item[\gls{gm}:]
  What does he say?
...
\begin{description}
  ...
  \item[\gls{gm}:]
  Roll \roll{Dexterity}{Brawl}, \glsentrylong{tn}~13.
  \item[Player 2:]
  \dicef{9}
...
\begin{description}
  ...
  \item[\gls{gm}:]
  Sure, and it's at \glsentrylong{tn}~10 this time.
  \item[Player 3:]
  Can I not stab the \gls{woodspy}?!
  \item[\gls{gm}:]
  Snow freezes around its every grounded tentacle, while Grogfen pulls away.
  Roll \roll{Dexterity}{Melee} at \glsentrylong{tn}~7.
  \item[Player 3:]
  \dicef{9}
  That's 8, how do I deal Damage again?
  \item[Player 1:]
  You sheet says $1D6+2$, so roll a die.
  \item[Player 3:]
