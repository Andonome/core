...
\subsection{Racial Ability: Unchanging}

Elves do not feel the stark march of time like the other races.
They must spend the \glspl{xp} they would usually receive from \glspl{storypoint} at character creation, meaning they start with 60 \glspl{xp} instead of the usual 50.
However, they do not receive the usual \glspl{xp} from spending \glspl{storypoint} until they have spent all 5 of their starting \glspl{storypoint}.
